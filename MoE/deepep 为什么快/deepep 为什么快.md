...
最近 megatron整合了deepep， 新增加了一个 MoEFlexTokenDispatcher。本文梳理 MoEAlltoAllTokenDispatcher 与 MoEFlexTokenDispatcher 的实现， 并在此基础上分析 MoEFlexTokenDispatcher 比 MoEAlltoAllTokenDispatcher快的原因。
...
这个通信冗余的问题在 ep 不跨机的时候可能不会有什么大问题（H100 nvlink 900G 带宽），但是如果ep 跨机了，通信成为瓶颈的时候，这会成为一个问题。
